...
export default {
  ...
  methods: {
    async fetchProducts() {
      try {
        ...
        const response = await axios.get("http://192.168.0.45/api/product/list", {
          params: {
            page: 1,
            size: 5,
          },
    ...
    async fetchOrders() {
      try {
        ...
        const response = await axios.get("http://192.168.0.45/api/orders/list", {
          params: {
            page: 1,
            size: 5,
          },
  ...
  try {
    ...
    const response = await axios.post("http://192.168.0.45/api/cart/addcart", CartCreateReq, {
      headers: {
        Authorization: `Bearer ${token}`,
