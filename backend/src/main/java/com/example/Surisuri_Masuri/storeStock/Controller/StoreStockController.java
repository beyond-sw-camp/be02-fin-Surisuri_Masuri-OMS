...
public class StoreStockController {
    ...
    public ResponseEntity storeStockCreate(@RequestHeader(value = "AccessToken") String token, @RequestBody StoreStockCreateReq storeStockCreateReq) {
    ...
    public ResponseEntity storeStockList(@RequestHeader(value = "AccessToken") String token, Integer page, Integer size) {
    ...
    public ResponseEntity storeStockSearch(@RequestHeader(value = "AccessToken") String token, @RequestBody StoreStockSearchReq storeStockSearchReq) {
        return ResponseEntity.ok().body(storeStockService.storeStockSearch(token, storeStockSearchReq));
    }

    // 재고 수정
    @PatchMapping("/stock/update")
    public ResponseEntity storeStockUpdate(@RequestHeader(value = "AccessToken") String token, @RequestBody StoreStockUpdateReq storeStockUpdateReq) {
    ...
    public ResponseEntity storeStockDelete(@RequestHeader(value = "AccessToken") String token, @RequestBody StoreStockDeleteReq storeStockDeleteReq) {
